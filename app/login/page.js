...
const Login = () => {
  ...
  return (
    <div classNameName="bg-slate-50 py-14 container mx-auto">
      <h1 className="text-center font-bold text-3xl text-white pt-12" >Login to get your fans to support you</h1>
